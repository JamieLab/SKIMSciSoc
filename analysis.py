...
##python_util.analysis_driver.shelf_current_analysis(params, generateBathymetry=False, generateShelfCoordinates=False, generateCellData=True, calculateShelfCurrents=False);
...
contourDepths = [500]; #[300, 400, 500, 600, 700];
