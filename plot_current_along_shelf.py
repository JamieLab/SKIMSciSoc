...
def plot_shelf_section(segmentDistances, data123, data789, xlabel, yRange=None, outputFile=None, alpha=0.25, noClose=False, laruelleSections=[], laruelleSectionNames=[]):
    ...
    ax1.set_ylabel(r"onto-shelf current $m s^{-1}$", fontsize=16);
    ...
    ax2.set_ylabel(r"onto-shelf current $m s^{-1}$", fontsize=16);
...
#Read data
gridwiseData = pd.read_table(path.join("data", params.paramsetName, "gridwise_data", "per_grid_cell_edge_data_"+params.paramsetName+".csv"), sep=',');
...
if plotEuropeanShelf:
    ...
    outputFile = "plots/current_along_shelf/flux_along_shelf_europeanShelf.pdf"
...
if plotMidAtlanticBight:
    ...
    outputFile = "plots/current_along_shelf/flux_along_shelf_midAtlanticBight.pdf"
...
if plotCoastOfJapan:
    ...
    outputFile = "plots/current_along_shelf/flux_along_shelf_coastOfJapan.pdf"
...
if plotPatagonia:
    ...
    outputFile = "plots/current_along_shelf/flux_along_shelf_patagonia.pdf"
...
if plotBeringSea:
    ...
    segmentDistances = np.cumsum(distances);
    xlabel = "distance along shelf (km, West to East)";
    outputFile = "plots/current_along_shelf/flux_along_shelf_BeringSea.pdf"
...
if plotAntarcticPeninsula:
    ...
    outputFile = "plots/current_along_shelf/flux_along_shelf_AntarcticPeninsula.pdf"
...
if plotLabradorSea:
    ...
    outputFile = "plots/current_along_shelf/flux_along_shelf_LabradorSea.pdf"
...
if plotTasmania:
    ...
    segmentDistances = np.cumsum(distances);
    xlabel = "distance along shelf (km, West to East)";
    outputFile = "plots/current_along_shelf/flux_along_shelf_Tasmania.pdf"
...
if plotBarentsSea:
    ...
    segmentDistances = np.cumsum(distances);
    xlabel = "distance along shelf (km, East to West)";
    outputFile = "plots/current_along_shelf/flux_along_shelf_BarentsSea.pdf"
...
if plotSouthAtlanticBight:
    ...
    segmentDistances = np.cumsum(distances);
    xlabel = "distance along shelf (km, South to North)";
    outputFile = "plots/current_along_shelf/flux_along_shelf_SouthAtlanticBight.pdf"
...
if plotSouthGreenland:
    ...
    segmentDistances = np.cumsum(distances);
    xlabel = "distance along shelf (km, West to East)";
    outputFile = "plots/current_along_shelf/flux_along_shelf_SouthGreenland.pdf"
...
if plotCascianShelf:
    ...
    segmentDistances = np.cumsum(distances);
    xlabel = "distance along shelf (km, North to South)";
    outputFile = "plots/current_along_shelf/flux_along_shelf_CascianShelf.pdf"
...
if plotIrmingerSea:
    ...
    segmentDistances = np.cumsum(distances);
    xlabel = "distance along shelf (km, West to East)";
    outputFile = "plots/current_along_shelf/flux_along_shelf_IrmingerSea.pdf"
