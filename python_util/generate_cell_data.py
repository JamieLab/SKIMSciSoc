...
#    numLines = params.numberOfBoundryApproximationLines; #Number of lines to use to approximate the shelf edge
    ...
    bathy = Dataset("data/GEBCO_bathymetry_"+str(params.pixelRes[1])+"x"+str(params.pixelRes[1])+"deg.nc", 'r');
    #lat = bathy.variables["lat"][params.ilatRange[0]:params.ilatRange[1]];
    #lon = bathy.variables["lon"][params.ilonRange[0]:params.ilonRange[1]];
