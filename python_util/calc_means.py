...
#        t1data.append(print_statistics(data, distances, "Wei East China Sea (Summer, Jul-Sept 2010-2016)", dataMask));
    ...
    if calculateTable2 == True:
        ...
        data123.ekmanAcrossShelf = np.roll(data123.ekmanAcrossShelf, -110);
        data123.ekmanAcrossShelfSD = np.roll(data123.ekmanAcrossShelfSD, -110);
        data123.geostrophicAcrossShelf = np.roll(data123.geostrophicAcrossShelf, -110);
        data123.geostrophicAcrossShelfSD = np.roll(data123.geostrophicAcrossShelfSD, -110);
        data123.stokesAcrossShelf = np.roll(data123.stokesAcrossShelf, -110);
        data123.stokesAcrossShelfSD = np.roll(data123.stokesAcrossShelfSD, -110);
        if calculateTable2GasTransferVelocity==True:
            data123.k = np.roll(data123.k, -110);
        ...
        data789.ekmanAcrossShelf = np.roll(data789.ekmanAcrossShelf, -110);
        data789.ekmanAcrossShelfSD = np.roll(data789.ekmanAcrossShelfSD, -110);
        data789.geostrophicAcrossShelf = np.roll(data789.geostrophicAcrossShelf, -110);
        data789.geostrophicAcrossShelfSD = np.roll(data789.geostrophicAcrossShelfSD, -110);
        data789.stokesAcrossShelf = np.roll(data789.stokesAcrossShelf, -110);
        data789.stokesAcrossShelfSD = np.roll(data789.stokesAcrossShelfSD, -110);
        if calculateTable2GasTransferVelocity==True:
            data789.k = np.roll(data789.k, -110);
        ...
        data123.ekmanAcrossShelf = np.roll(data123.ekmanAcrossShelf, rollAmount);
        data123.ekmanAcrossShelfSD = np.roll(data123.ekmanAcrossShelfSD, rollAmount);
        data123.geostrophicAcrossShelf = np.roll(data123.geostrophicAcrossShelf, rollAmount);
        data123.geostrophicAcrossShelfSD = np.roll(data123.geostrophicAcrossShelfSD, rollAmount);
        data123.stokesAcrossShelf = np.roll(data123.stokesAcrossShelf, rollAmount);
        data123.stokesAcrossShelfSD = np.roll(data123.stokesAcrossShelfSD, rollAmount);
        if calculateTable2GasTransferVelocity==True:
            data123.k = np.roll(data123.k, rollAmount);
        ...
        data789.ekmanAcrossShelf = np.roll(data789.ekmanAcrossShelf, rollAmount);
        data789.ekmanAcrossShelfSD = np.roll(data789.ekmanAcrossShelfSD, rollAmount);
        data789.geostrophicAcrossShelf = np.roll(data789.geostrophicAcrossShelf, rollAmount);
        data789.geostrophicAcrossShelfSD = np.roll(data789.geostrophicAcrossShelfSD, rollAmount);
        data789.stokesAcrossShelf = np.roll(data789.stokesAcrossShelf, rollAmount);
        data789.stokesAcrossShelfSD = np.roll(data789.stokesAcrossShelfSD, rollAmount);
        if calculateTable2GasTransferVelocity==True:
            data789.k = np.roll(data789.k, rollAmount);
        ...
        df.columns = ["region", "total across-shelf", "total across-shelf SD", "proportionEks", "proportionEksSD", "proportionGeo", "proportionGeoSD", "proportionStokes", "proportionStokesSD", "percentEks", "percentEksSD", "percentGeo", "percentGeoSD", "percentStokes", "percentStokesSD", "k", "kSD"];
        ...
        distances = np.array(gridwiseData["distance"])[data123.regionMask]/1000.0; #in km
        dists, laruIrmingerSeaMask = mf.calculate_km_subsection_bounds_along_shelf(data123.xcoords, data123.ycoords, distances, mf.laruelle_IrmingerSea, params, testPlot=True);
